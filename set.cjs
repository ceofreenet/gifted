...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~rZFiMdG8",
  PREFIX: process.env.PREFIX || '.',
  AUTO_READ_STATUS: process.env.AUTO_READ_STATUS !== true ? process.env.AUTO_READ_STATUS === 'true' : true,
  AUTO_REPLY_STATUS: process.env.AUTO_REPLY_STATUS !== true process.env.AUTO_REPLY_STATUS === 'true' : false,
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by CEO-FreeNet',
  ...
  ALWAYS_ONLINE: process.env.ALWAYS_ONLINE !== true process.env.ALWAYS_ONLINE === 'true' : true,
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "256783678577",
